/********************************************************************************
** Form generated from reading UI file 'qsamplesimulator.ui'
**
...
#ifndef UI_QSAMPLESIMULATOR_H
#define UI_QSAMPLESIMULATOR_H
...
public:
    ...
    void setupUi(QWidget *QsampleSimulator)
    {
        if (QsampleSimulator->objectName().isEmpty())
            QsampleSimulator->setObjectName(QStringLiteral("QsampleSimulator"));
        QsampleSimulator->resize(319, 339);
        horizontalLayout = new QHBoxLayout(QsampleSimulator);
        horizontalLayout->setSpacing(0);
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        m_phoneWidget = new QStackedWidget(QsampleSimulator);
        ...
        m_lblHeading_2->setText(QStringLiteral("<span style=\" font-size:18pt;\">Qsample</span>"));
        ...
        retranslateUi(QsampleSimulator);

        m_phoneWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(QsampleSimulator);
    } // setupUi

    void retranslateUi(QWidget *QsampleSimulator)
    {
        QsampleSimulator->setWindowTitle(QApplication::translate("QsampleSimulator", "Form", 0));
        m_btnStart->setText(QApplication::translate("QsampleSimulator", "&Start", 0));
        label->setText(QApplication::translate("QsampleSimulator", "You have completed the qsample", 0));
        m_lblTotalCorrect->setText(QApplication::translate("QsampleSimulator", "Total correct: %1", 0));
        m_lblTotalWrong->setText(QApplication::translate("QsampleSimulator", "Total wrong: %1", 0));
        m_lblTotalUnanswered->setText(QApplication::translate("QsampleSimulator", "Total unanswered: %1", 0));
        m_btnExit->setText(QApplication::translate("QsampleSimulator", "&Exit", 0));
        m_btnRestart->setText(QApplication::translate("QsampleSimulator", "&Restart", 0));
    } // retranslateUi

};

namespace Ui {
    class QsampleSimulator: public Ui_QsampleSimulator {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_QSAMPLESIMULATOR_H
